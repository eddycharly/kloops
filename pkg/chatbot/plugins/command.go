...
type CommandInvoker struct {
	Condition func(GenericCommentEvent) bool
...
func Always(_ GenericCommentEvent) bool {
	return true
}

// Never is a condition that always evaluates to false
func Never(_ GenericCommentEvent) bool {
	return false
}

// Not negates a condition
func Not(condition ConditionFunc) ConditionFunc {
	return func(e GenericCommentEvent) bool {
		return !condition(e)
	}
}
...
func (action CommandInvoker) When(conditions ...ConditionFunc) CommandInvoker {
	return CommandInvoker{
		Condition: func(e GenericCommentEvent) bool {
...
type ConditionFunc func(GenericCommentEvent) bool
...
func (cmd Command) InvokeCommandHandler(ce GenericCommentEvent, handler func(CommandEventHandler, GenericCommentEvent, CommandMatch) error) error {
...
func (cmd Command) FilterAndGetMatches(event *GenericCommentEvent) ([]CommandMatch, error) {
